...
import { Loader2, AlertCircle, Star, Clock, Radio as RadioIcon } from 'lucide-react';
      ...
      <div className="sticky top-[72px] z-10 bg-zad-midnight border-b border-zad-border/60 px-4 py-3">
        <div className="flex gap-2">
          ...
          >
            ...
            {isAr ? 'الكل' : 'All'}
            <span className="text-xs opacity-70">({stations.length})</span>
          </button>
          ...
          >
            ...
            {isAr ? 'الأخيرة' : 'Recent'}
            <span className="text-xs opacity-70">({recentPlayed.length})</span>
          </button>
        </div>
      </div>
